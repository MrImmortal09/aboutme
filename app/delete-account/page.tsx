...
export default function DeleteAccount() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (email) {
      setSubmitted(true);
      // Here you would typically make an API call to record the deletion request
    }
  };
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700">
                    <p>
                      We have received your account deletion request. We will contact you at <strong>{email}</strong> within 2 business days to process this request.
                    </p>
                  </div>
                </div>
              </div>
